          ...
          return (
            <Card key={e.id} className="p-5 shadow-soft">
              <div className="flex items-center gap-3">
                ...
                <div><p className="font-semibold">{e.name}</p><p className="text-xs text-muted-foreground">{e.designation}</p></div>
              </div>
              <div className="mt-4">
                <div className="flex items-center justify-between text-sm"><span>Score</span><span className="font-semibold">{score}/100</span></div>
