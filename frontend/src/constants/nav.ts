...
export const NAV: Record<Role, NavItem[]> = {
  employee: [
    ...
    { to: "/employee/tasks", label: "Tasks", icon: ClipboardList },
  ...
  hr: [
    ...
    { to: "/hr/tasks", label: "Tasks", icon: ClipboardList },
  ...
  "super-admin": [
    ...
    { to: "/super-admin/tasks", label: "Tasks", icon: ClipboardList },
    { to: "/super-admin/mail", label: "Mail Center", icon: Mail },
