    ...
    <div className="relative min-h-dvh overflow-hidden bg-background">
      ...
      <header className="mx-auto flex max-w-7xl items-center justify-between px-6 py-6">
        <div className="flex items-center gap-4">
          <div className="flex h-20 w-20 shrink-0 items-center justify-center overflow-hidden rounded-full border border-black/10 bg-white shadow-soft ring-1 ring-black/5">
            <BrandLogo className="h-full w-full object-cover" />
          </div>
          <span className="hidden text-lg font-bold tracking-tight text-muted-foreground sm:block">
            {BRAND.productName}
          </span>
        </div>
      </header>
