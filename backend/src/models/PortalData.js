    ...
    new mongoose.Schema(
      {
        ...
        employeeNo: { type: String, trim: true, maxlength: 40 },
        designation: { type: String, trim: true, maxlength: 120 },
        department: { type: String, trim: true, maxlength: 120 },
        dateOfJoining: { type: String, trim: true, maxlength: 40 },
        ...
        overtimeBonus: { type: Number, min: 0, default: 0 },
        specialAllowance: { type: Number, min: 0, default: 0 },
        incomeTaxTds: { type: Number, min: 0, default: 0 },
