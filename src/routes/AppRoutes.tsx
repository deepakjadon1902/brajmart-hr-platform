  ...
  return (
    <Suspense fallback={<Fallback />}>
      <Routes>
        ...
        {/* Employee */}
        <Route path="/employee" element={<ProtectedRoute allow="employee"><PortalLayout role="employee" /></ProtectedRoute>}>
        ...
        {/* HR */}
        <Route path="/hr" element={<ProtectedRoute allow="hr"><PortalLayout role="hr" /></ProtectedRoute>}>
        ...
        {/* Team Manager */}
        <Route path="/team-manager" element={<ProtectedRoute allow="team-manager"><PortalLayout role="team-manager" /></ProtectedRoute>}>
        ...
        {/* Super Admin */}
        <Route path="/super-admin" element={<ProtectedRoute allow="super-admin"><PortalLayout role="super-admin" /></ProtectedRoute>}>
