import {
  LayoutDashboard, User, CalendarDays, FileText, Briefcase, Bell, MessageSquare, Settings,
  Users, ClipboardList, Award, UserPlus, Building2, ShieldCheck, BarChart3, Mail, Megaphone,
  Calendar, Wallet, Package, LogOut, Workflow, ListChecks, Activity, Globe,
} from "lucide-react";
...
export const NAV: Record<Role, NavItem[]> = {
  employee: [
    ...
    { to: "/employee/shifts",      label: "Shifts",         icon: Workflow },
    { to: "/employee/payslips",    label: "Payslips",       icon: Wallet },
    { to: "/employee/documents",   label: "Documents",      icon: FileText },
    { to: "/employee/assets",      label: "Assets",         icon: Package },
    { to: "/employee/onboarding",  label: "Onboarding",     icon: UserPlus },
    { to: "/employee/exit",        label: "Exit",           icon: LogOut },
...
export const ROLE_META: Record<Role, { title: string; accent: string; loginPath: string; home: string }> = {
  employee:      { title: "Employee Portal",     accent: "from-indigo-500 to-violet-500", loginPath: "/employee/login",     home: "/employee/dashboard" },
  hr:            { title: "HR Portal",           accent: "from-emerald-500 to-teal-500",  loginPath: "/hr/login",           home: "/hr/dashboard" },
  "team-manager":{ title: "Team Manager Portal", accent: "from-sky-500 to-cyan-500",      loginPath: "/team-manager/login", home: "/team-manager/dashboard" },
  "super-admin": { title: "Super Admin Portal",  accent: "from-rose-500 to-fuchsia-500",  loginPath: "/super-admin/login",  home: "/super-admin/dashboard" },
};
